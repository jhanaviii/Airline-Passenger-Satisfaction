...
latest_version = client.get_latest_versions(name='Airline Passenger Satisfaction Classifier', stages=['Staging'])[0].version
...
print(f"Model '{model_name}' version: {latest_version} transitioned successfully from 'Staging' to 'Production'.")